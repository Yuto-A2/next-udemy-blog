        ...
        <div className="container mx-auto mt-10">
            ...
            <form action={formAction} className="space-y-4">
                <div>
                    ...
                    {state.errors.title && (
                        <p className="text-red-500 text-sm mt-1">{state.errors.title.join(',')}
                        </p>
                    )}
                </div>
                <div>
                    ...
                    {state.errors.topImage && (
                        <p className="text-red-500 text-sm mt-1">{state.errors.topImage.join(',')}
                        </p>
                    )}
                </div>
                <div>
                    ...
                    {state.errors.content && (
                        <p className="text-red-500 text-sm mt-1">{state.errors.content.join(',')}
                        </p>
                    )}
                </div>
